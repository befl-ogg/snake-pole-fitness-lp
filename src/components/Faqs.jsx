...
const FAQData = [
  {
    question: "¿Puedo actualizar mi plan o membresía?",
    answer:
  ...
  {
    question: "¿Qué es la reposición por mes?",
    answer:
  ...
  {
    question: "¿Cómo puedo adquirir mi membresía?",
    answer:
...
export const FAQ = () => (
  <section className="relative pt-16 pb-16 bg-blueGray-50 overflow-hidden" id="faqs">
